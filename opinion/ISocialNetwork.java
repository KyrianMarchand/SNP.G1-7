...
public interface ISocialNetwork {
	 ...
	 *                                      <ul>
	 *                                      <li>if login is not instantiated or
	 *                                      contains less than one
	 *                                      non-space character</li>
	 *                                      <li>if password is not instantiated or
	 *                                      contains less than
	 *                                      four characters (not taking into account
	 *                                      leading or trailing
	 *                                      blanks)</li>
	 ...
	 *                                      if a member with the same login is
	 *                                      already registered in the
	 *                                      <i>SocialNetwork</i> (same login : not
	 *                                      case-sensitive and
	 *                                      leadings/trailings blanks are not taken
	 *                                      into account)
	 * 
	 */
	 ...
	 *                                        <li>if password is not instantiated or
	 *                                        contains less than
	 *                                        four characters (not taking into
	 *                                        account leading or trailing
	 *                                        blanks)</li>
	 *                                        <li>if title is not instantiated or
	 *                                        contains less than one
	 *                                        non-space character</li>
	 *                                        <li>if kind is not instanciated</li>
	 *                                        <li>if director is not
	 *                                        instanciated</li>
	 *                                        <li>if scenarist is not
	 *                                        instanciated</li>
	 *                                        <li>if duration is not stricly
	 *                                        positive
	 *                                        </ul>
	 *                                        <br>
	 * @throws NotMemberException
	 *                                        if login does not match with the login
	 *                                        of a registered member
	 *                                        in <i>SocialNetwork</i> or if password
	 *                                        does not correspond to
	 *                                        his registered password.
	 * @throws ItemFilmAlreadyExistsException
	 *                                        : a film with the same title is
	 *                                        already registered in the
	 *                                        <i>SocialNetwork</i> (same title : not
	 *                                        case-sensitive and
	 *                                        leadings/trailings blanks are not
	 *                                        taken into account)
	 * 
	 */
	 ...
	 *                                        a book with the same title is already
	 *                                        registered in the
	 *                                        <i>SocialNetwork</i> (same title : not
	 *                                        case-sensitive and
	 *                                        leadings/trailings blanks are not
	 ...
	 *                            <br>
	 * @throws NotMemberException
	 *                            if login does not match with the login of a
	 *                            registered member
	 *                            in <i>SocialNetwork</i> or if password does not
	 *                            correspond to
	 *                            his registered password.
	 * @throws NotItemException
	 *                            if title is not registered as a film's title in
	 *                            the
	 *                            <i>SocialNetwork</i>
	 * 
	 ...
	 *                            his registered password.
	 * @throws NotItemException
	 *                            if title is not registered as a book's title in
	 *                            the
	 *                            <i>SocialNetwork</i>
	 * 
	 ...
	 * 
	 * @throws BadEntryException
	 *                           if title is not instantiated or contains less than
	 *                           one
	 *                           non-space character
	 * 
