...
public class TestReport {
	 ...
	 * @param nbErrors Total number of errors that were detected while running these
	 *                 tests.
	 * @throws NotTestReportException if nbTests and/or nbErrors are not complying
	 *                                with the following constraints : nbTests and
	 *                                nbErrors should be positive, nbTests should be
	 *                                greater or equal to nbErrors
	 */
	public TestReport(int nbTests, int nbErrors) throws NotTestReportException {
		if ((nbTests < 0) || (nbErrors < 0) || (nbTests < nbErrors))
			throw new NotTestReportException();
	...
	public static void main(String[] args) {
		...
		// check if TestReport() throws NotTestReportException for some inaccurate
		// arguments
		try {
