...
public class AddBookTest {
    ...
    private static int addBookBadEntryTest(ISocialNetwork sn, String login, String password, String title, String kind,
            String author, String nbpages, String testId, String errorMessage) {
